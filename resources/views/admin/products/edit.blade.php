        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" name="ram_gb"
                       ...
                       value="{{ old('ram_gb', $product->ram_gb) }}" required>
                @error('ram_gb')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="storage_gb"
                       ...
                       value="{{ old('storage_gb', $product->storage_gb) }}" required>
                @error('storage_gb')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <select name="storage_type"
                        class="w-full p-2 border rounded @error('storage_type') border-red-500 @enderror">
                    <option value="SSD" {{ old('storage_type', $product->storage_type) == 'SSD' ? 'selected' : '' }}>SSD</option>
            ...
            <div>
                ...
                <input type="number" step="0.1" name="display_size_inch"
                       ...
                       value="{{ old('display_size_inch', $product->display_size_inch) }}" required>
            ...
            <div>
                ...
                <input type="text" name="display_resolution"
                       ...
                       value="{{ old('display_resolution', $product->display_resolution) }}" required>
            ...
            {{-- IMAGE --}}
            <div>
                <label class="font-semibold block mb-1">Image</label><br>
                @if ($product->image)
                    {{-- Menggunakan accessor yang Anda buat di model: $product->image_url --}}
                    <img src="{{ $product->image_url }}" alt="Product Image" class="h-20 mb-2">
                @endif
            ...
            <div>
                ...
                <select name="is_active"
                    ...
                    {{-- Cek menggunakan old() atau nilai produk --}}
